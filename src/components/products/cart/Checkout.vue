    ...
    <div class="row mt-5">
      <div class="col-sm-8">
        <form id="productCU">
          ...
          <p> Nous vous contacterons via sms , ou par les réseaux sociaux
            
            Appelez nous ou écrivez nous au 697476283 </p>
          <br>
        </form>
      </div>
      <div class="col-sm-4">
...
export default {
  ...
  methods: {
    createShippingDetail() {
       const IDproducts = JSON.parse(localStorage.getItem("all_product"));
       this.shipping.IDproduct=IDproducts
      // sauvegarde de l'achat dans la base de donnée 
