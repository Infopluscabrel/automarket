    ...
    <div class="row mt-5">
            ...
            <div class="col-md-4" v-for="(item, index) in cartProducts" :key="index">
              <div class="card mb-4 shadow-sm" style="height: 410px">
                <img
                  ...
                  alt="Card image cap"
                  style="max-height: 700px; width:100%;max-width: 150.135px;margin: auto"
                >
                <div class="card-body">
      ...
      <div class="col-4">
        ...
        <ul class="list-group mb-3">
          <router-link to="/checkout" class="btn btn-primary mt-2 text-white">Valider</router-link>
          <router-link to="/products" class="btn btn-danger mt-3 text-white"> 
